...
#define PEC_SIZE                 1U  /*!< PEC size in bytes                                   */
...
#define BLK_RD_OR_WR    ((uint8_t)0x70)    /*!< Command can be executed either as read or as write of variable size */
  ...
  /* ------------ notable addresses -------------------- */
#define SMBUS_ADDR_ARA           ((uint8_t)0x18) /*!< Address used in alert response */
#define SMBUS_ADDR_HOST          ((uint8_t)0x10) /*!< Host address used in ARP */
#define SMBUS_ADDR_SBCHARGER     ((uint8_t)0x12) /*!< Typical charger address  */
#define SMBUS_ADDR_SBSELECTOR    ((uint8_t)0x14) /*!< Typical selector address */
#define SMBUS_ADDR_SB            ((uint8_t)0x16)
#define SMBUS_ADDR_ZONE_READ     ((uint8_t)0x50)
#define SMBUS_ADDR_ZONE_WRITE    ((uint8_t)0x6E)
#define SMBUS_ADDR_LCD           ((uint8_t)0x58)
#define SMBUS_ADDR_CCFL          ((uint8_t)0x5A) /*!< Typical CCFL backlight address*/
#define SMBUS_ADDR_ACCESS_DEF    ((uint8_t)0x6E)
#define SMBUS_ADDR_PCMCIA        ((uint8_t)0x86) /*!< mask, not actual value */
#define SMBUS_ADDR_VGA           ((uint8_t)0x88)
#define SMBUS_ADDR_DEFAULT       ((uint8_t)0xC2) /*!< not valid device address, used for ARP */
#define SMBUS_ADDR_DEVICE        ((uint8_t)0x02)
