...
/* Cannot have 1.3 while excluding 1.2 features */
#ifndef PMBUS12
#define PMBUS12
#endif /* PMBUS12 */
...
#define PMBUS_CMD_TBL_SIZE              ((uint8_t)21)
...
#ifndef SMBUS_OTHER_FRAME
#define SMBUS_OTHER_FRAME                      ((uint32_t)(0x12341234))
#endif /*SMBUS_OTHER_FRAME*/
/*!< Transfer frame for ZONE_READ */  
...
HAL_StatusTypeDef STACK_PMBUS_MasterReadZoneStatus(SMBUS_StackHandleTypeDef *pStackContext, uint8_t ccode,
    uint8_t mask);
